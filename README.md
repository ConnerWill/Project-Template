...
<pre align="center">
<a href="#seedling--setup">SETUP</a> • <a href="#four_leaf_clover--key-bindings">KEYBINDS</a> • <a href="https://deviantart.com/ConnerWill/art/Sakura-Saber-872360153">GALLERY</a> • <a href="#herb--guides">GUIDES</a>
</pre>

<h1>
  <a href="#--------">
    <img alt="" align="right" src="https://badges.pufler.dev/visits/ConnerWill/dotfiles?style=flat-square&label=&color=000000&logo=github&logoColor=white&labelColor=000000"/>
  </a>
</h1>
...
- **Window Manager** :bento: [Openbox]https://connerwill.com/WEBSITEPLACEHOLDER.html) dual themes!
- **Openbox Menu** :cyclone: [obmenu-generator](https://github.com/ConnerWill/_PLACEHOLDER_)
- **Panel** :blossom: [Tint2](https://gitlab.com/o9000/tint2) with material design and glyphs!
- **Application Launcher** :rocket: [Rofi](https://github.com/ConnerWill/_PLACEHOLDER_)
- **Desktop Notification** :herb: [Dunst](https://github.com/ConnerWill/_PLACEHOLDER_)
- **Terminal Emulator** :leaves: [URxvt]https://connerwill.com/WEBSITEPLACEHOLDER.html) which lightest!
- **Shell** :shell: [Zsh]https://dampsock.com/index.html)
- **Compositor** :shaved_ice: [Picom](https://github.com/ConnerWill/_PLACEHOLDER_)
- **File Manager** :flower_playing_cards: [Thunar]https://dampsock.com/index.html) customized side-pane!
- **Media Player** :city_sunset: [mpv](https://mpv.io) with modern OSC!
- **Music Player** :milky_way: [Ncmpcpp](https://github.com/ConnerWill/_PLACEHOLDER_)
- **GUI (Basic) IDE** :space_invader: [Geany]https://dampsock.com/index.html) for the win!

<h1>
  <a href="#---------1">
    <img alt="" align="right" src="https://img.shields.io/github/commit-activity/m/ConnerWill/dotfiles/ng?style=flat-square&label=&color=000000&logo=gitbook&logoColor=white&labelColor=000000"/>
  </a>
</h1>
...
<p align="right">
  [<a href="https://gitlab.com/ConnerWill/dotfiles">mirror</a>]
</p>
...
<table align="right">
  ...
  <tr>
    <td align="center">
      <a href="https://github.com/ConnerWill/_PLACEHOLDER_)
...
- **GTK theme and icon updates and fixes**
  - [Papirus-Custom](https://github.com/ConnerWill/_PLACEHOLDER_)
    [Papirus-Dark-Custom](https://github.com/ConnerWill/_PLACEHOLDER_)
    patches
    - 16x16
      - apps
        - diodon.svg
...
[~~Read here~~](https://ConnerWill.github.io/iolr).
[~~Also~~ Currently available in Bahasa Indonesia](https://ConnerWill.github.io/id/iolr).
...
> **WATCH YOUR STEP!!!**  
> There's a [critical warning](https://github.com/ConnerWill/_PLACEHOLDER_)
...
[Debian SID]https://dampsock.com/index.html) recommended.
...
Contents of [1]https://dampsock.com/index.html),
[2]https://dampsock.com/index.html),
[3]https://dampsock.com/index.html).

[Here for python (3) if not already installed]https://dampsock.com/index.html).
...
[2]https://dampsock.com/index.html),
[3]https://dampsock.com/index.html),
[4]https://dampsock.com/index.html),
[5]https://dampsock.com/index.html),
[6]https://dampsock.com/index.html),
[7]https://dampsock.com/index.html),
[8]https://dampsock.com/index.html).

[Here to install obmenu-generator]https://dampsock.com/index.html).
...
Spotify is also integrated but optional, [here to install]https://dampsock.com/index.html).
...
[7]https://dampsock.com/index.html),
[8]https://dampsock.com/index.html),
[9]https://dampsock.com/index.html).

Choose your own polkit authentication-agent. [lxpolkit]https://dampsock.com/index.html)?
...
[8]https://dampsock.com/index.html),
[9]https://dampsock.com/index.html),
[10]https://dampsock.com/index.html).
...
[Here for improved nanorc with syntax-highlighting](https://github.com/ConnerWill/_PLACEHOLDER_)

I personally use NetworkManager (and IWD as wireless back-end) with nm-applet,
[here it is]https://dampsock.com/index.html).
...
[Arch Linux]https://dampsock.com/index.html) recommended.
...
[polkit-gnome]https://dampsock.com/index.html)?
...
[Gentoo Linux]https://dampsock.com/index.html) extremely recommended. Expert!
...
> Note that some packages require accepting [arch~ keywords]https://dampsock.com/index.html).
> It's highly recommended.

> See also USE flags, it's complicated to explain.
> [You may want to see mine](https://github.com/ConnerWill/_PLACEHOLDER_)
...
> My own [Lilium portage overlay](https://github.com/ConnerWill/_PLACEHOLDER_)
...
[3]https://dampsock.com/index.html),
[4]https://dampsock.com/index.html),
[5](https://github.com/ConnerWill/_PLACEHOLDER_)
[6]https://dampsock.com/index.html),
[7]https://dampsock.com/index.html),
[8]https://dampsock.com/index.html),
[9]https://dampsock.com/index.html).
...
> I personally don't use [GURU portage overlay]https://dampsock.com/index.html)
...
> I personally don't use [Miramir's portage overlay](https://github.com/ConnerWill/_PLACEHOLDER_)
> and build manually instead.  
...
[2]https://dampsock.com/index.html),
[3]https://dampsock.com/index.html),
[4](https://github.com/ConnerWill/_PLACEHOLDER_)
[5]https://dampsock.com/index.html),
[6]https://dampsock.com/index.html),
[7]https://dampsock.com/index.html),
[8]https://dampsock.com/index.html),
...
The [BSD variants]https://dampsock.com/index.html)
haven't been tested at all, probably some of the extensions are [GNU]https://dampsock.com/index.html)'s
and [Linux-specific]https://dampsock.com/index.html).
...
```sh
💲 git clone --depth 1 https://github.com/ConnerWill/_PLACEHOLDER_)
```
...
|:--------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------|:----------------------------------------------------|
| [GNOME Cantarell]https://dampsock.com/index.html) | `cantarell-fonts-0.303.1/prebuilt/Cantarell-VF.otf` |
| [Google Comfortaa Regular](https://raw.githubusercontent.com/googlefonts/comfortaa/main/fonts/OTF/Comfortaa-Regular.otf)  | [OFL-1.1](https://github.com/ConnerWill/_PLACEHOLDER_)
| [Google Comfortaa Bold](https://raw.githubusercontent.com/googlefonts/comfortaa/main/fonts/OTF/Comfortaa-Bold.otf)        | [OFL-1.1](https://github.com/ConnerWill/_PLACEHOLDER_)
| [Feather IcoMoon](https://github.com/ConnerWill/_PLACEHOLDER_)
| [Material IcoMoon](https://github.com/ConnerWill/_PLACEHOLDER_)
| [Iosevka Nerd Font ... Mono](https://github.com/ConnerWill/_PLACEHOLDER_)
| [M+ 1mn Nerd Font Complete](https://github.com/ConnerWill/_PLACEHOLDER_)
| [M+ 1mn Nerd Font ... Mono](https://github.com/ConnerWill/_PLACEHOLDER_)
...
```bash
💲 wget --no-hsts -cNP ~/.fonts/IcoMoon-Custom/ https://github.com/ConnerWill/_PLACEHOLDER_)
```

```sh
💲 wget --no-hsts -cNP ~/.fonts/Nerd-Patched/ https://github.com/ConnerWill/_PLACEHOLDER_)
```
...
Additionally, install the noto ([emoji takes precedence](https://github.com/ConnerWill/_PLACEHOLDER_)
broad support. [Debian]https://dampsock.com/index.html).
[Arch]https://dampsock.com/index.html).
...
|:----------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------|:----------------------------|
| [Gladient](https://github.com/ConnerWill/_PLACEHOLDER_)
| [Papirus-Custom](https://github.com/ConnerWill/_PLACEHOLDER_)
| [Papirus-Dark-Custom](https://github.com/ConnerWill/_PLACEHOLDER_)
...
```bash
💲 wget --no-hsts -cN https://github.com/ConnerWill/_PLACEHOLDER_)
```
...
**Why do I need to link icons to [/usr]https://dampsock.com/index.html)?**  
It's [required by dunst program](https://github.com/ConnerWill/_PLACEHOLDER_)
...
|:-----------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------|:------------------------------|
| [batik-1_4K](https://github.com/ConnerWill/_PLACEHOLDER_)
| [okita-souji_FHD](https://github.com/ConnerWill/_PLACEHOLDER_)
| [cherry-blossoms_FHD](https://github.com/ConnerWill/_PLACEHOLDER_)
| [floral-artistic-2_FHD](https://github.com/ConnerWill/_PLACEHOLDER_)
...
```bash
💲 wget --no-hsts -cNP ~/.wallpapers/mechanical/ https://github.com/ConnerWill/_PLACEHOLDER_)
```

```bash
💲 wget --no-hsts -cNP ~/.wallpapers/eyecandy/ https://github.com/ConnerWill/_PLACEHOLDER_)
```

Old wallpapers [can be found here](https://github.com/ConnerWill/_PLACEHOLDER_)
...
|:---------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------|:------------------|
| [resize-font](https://raw.githubusercontent.com/simmel/urxvt-resize-font/master/resize-font) | [ISC](https://github.com/ConnerWill/_PLACEHOLDER_)
| [tabbedex](https://raw.githubusercontent.com/mina86/urxvt-tabbedex/master/tabbedex)          | [GPL-3.0](https://github.com/ConnerWill/_PLACEHOLDER_)
...
You can clone or [download as archive](https://github.com/ConnerWill/_PLACEHOLDER_)
...
> This repository auto-mirrored to https://gitlab.com/ConnerWill/dotfiles.git.

```sh
💲 git clone --depth 1 --recurse-submodules https://github.com/ConnerWill/_PLACEHOLDER_)
```
...
such as lightdm, gdm, etc. If you're using [`~/.xinitrc`]https://dampsock.com/index.html)
...
**[Init-freedom]https://dampsock.com/index.html) Linux distributions**
...
[heredocs]https://dampsock.com/index.html) that won't be updated to avoid replacing
...
> Use the find program to check the pattern. It's called [globbing]https://dampsock.com/index.html).
> ```sh
...
[DPMS]https://dampsock.com/index.html).
...
[XDG directories]https://dampsock.com/index.html) such as Documents,
...
Team](https://github.com/ConnerWill/_PLACEHOLDER_)
...
- [Do Live Calculations in Rofi!](https://github.com/ConnerWill/_PLACEHOLDER_)
- [Telegram Desktop Nord Theme](https://t.me/addtheme/nord_colors)
- [Recommended Modern Unix Utilities](https://github.com/ConnerWill/_PLACEHOLDER_)
- [Chrome-based Hardware Acceleration](https://linuxuprising.com/2021/01/how-to-enable-hardware-accelerated.html)
- [Automatic Tiling for EWMH-compliant WMs](https://github.com/ConnerWill/_PLACEHOLDER_)
...
> **LEGEND**  
> [<kbd>super</kbd>]https://dampsock.com/index.html)
...
[Anime4K shaders](https://github.com/ConnerWill/_PLACEHOLDER_)
...
[Thunar]https://dampsock.com/index.html)
...
Started [passively since 2018](https://github.com/ConnerWill/_PLACEHOLDER_)
...
[Cherry Blossom]https://dampsock.com/index.html). Blue expresses the creator's seeking peace or
...
[version 2](https://deviantart.com/ConnerWill/art/Joyful-Desktop-v2-858107208), darkness was inspired by
[Dystopia]https://dampsock.com/index.html) (while the creator listened to
[The Astonishing]https://dampsock.com/index.html) by
[Dream Theater]https://dampsock.com/index.html),
a reflection of unhappiness and suffering. In contrast, natural scenery, a reflection of inner satisfaction.
Now since the pre-release [version 4](https://github.com/ConnerWill/_PLACEHOLDER_)
...
<img alt="" align="center" width="96%" src="https://api.star-history.com/svg?repos=ConnerWill/dotfiles&type=Date"/>
</a>
</pre>
...
[![](https://liberapay.com/assets/widgets/donate.svg)](https://liberapay.com/ConnerWill/donate)

## :bouquet: ‎ <samp>ACKNOWLEDGEMENTS</samp>

|           |   | Inspiration and Resources                                   |                                                                                                                                                              |            |
|:---------:|:-:|:------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------:|
|           | 1 | [Elena](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 2 | [Adhi Pambudi](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 3 | [Fikri Omar](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 4 | [Rizqi Nur Assyaufi](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 5 | [Muktazam Hasbi Ashidiqi](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 6 | [Galih Wisnuaji](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 7 | [Ghani Rafif](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 8 | [Dylan Araps](https://github.com/ConnerWill/_PLACEHOLDER_)
|           | 9 | [Niivu](https://github.com/ConnerWill/_PLACEHOLDER_)
|           |   |                                                             |                                                                                                                                                              |            |
| **Group** |   | **Contributors**                                            | **Contributions**                                                                                                                                            | **Status** |
| Unlisted  | 1 | [Ekaunt](https://github.com/ConnerWill/_PLACEHOLDER_)
| Unlisted  | 2 | [HopeBaron](https://github.com/ConnerWill/_PLACEHOLDER_)
| Unlisted  | 3 | [Justin Faber](https://github.com/ConnerWill/_PLACEHOLDER_)
| Unlisted  | 4 | [Vcyzteen](https://github.com/ConnerWill/_PLACEHOLDER_)
| Verified  | * | [![](https://contrib.rocks/image?repo=ConnerWill/dotfiles)](https://github.com/ConnerWill/_PLACEHOLDER_)
|           |   |                                                             |                                                                                                                                                              |            |
