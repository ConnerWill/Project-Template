...
function replace-placeholders(){
  ...
  searchstring="$1"
  [[ -z "$searchstring" ]] \
    && printf '\e[0;1;48;5;196;38;5;15m ERROR \e[0;38;5;190m  %s\e[0;1;38;5;201m :(\e[0m\n' "$_find_and_replace_no_search_input_error" && return 1
  replacestring="$2"
  [[ -z "$replacestring" ]] \
    && printf '\e[0;1;48;5;196;38;5;15m ERROR \e[0;38;5;190m  %s\e[0;1;38;5;201m :(\e[0m\n' "$_find_and_replace_no_replace_input_error" && return 1
